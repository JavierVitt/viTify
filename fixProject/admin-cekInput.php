...
if (isset($_POST["search"])) {
  ...
  if ($cek == '') {
    ...
    $syntax = "SELECT * FROM CEK WHERE judul_laguc LIKE '%$cek%' OR penyanyic LIKE '%$cek%' OR genrec LIKE '%$cek%' OR tanggal_rilisc LIKE '%$cek%' OR linkc LIKE '%$cek%'";
    $hasils = query($syntax);
  }
}
?>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <a class="nav-link mx-2 active" href="admin-cekInput.php">Cek Input User</a>
              </li>
    ...
    <table class="table table-bordered">
      ...
      <?php foreach ($hasils as $hasil) : ?>
        <tr>
          ...
          <td>
            <?php echo $hasil["id_cek"]; ?>
          </td>
          <td>
            <?php echo $hasil["judul_laguc"]; ?>
          </td>
          <td>
            <?php echo $hasil["penyanyic"]; ?>
          </td>
          <td>
            <?php echo $hasil["genrec"]; ?>
          </td>
          <td>
            <?php echo $hasil["tanggal_rilisc"] ?>
          </td>
          <td>
            <?php echo $hasil["linkc"]; ?>
          </td>
          <td>
            <a class="btn btn-danger" href="deleteCek.php?id=<?php echo $hasil["id_cek"]; ?>">Delete !!</a>
            <a class="btn btn-success" href="addSongFromUserInput.php?id=<?php echo $hasil["id_cek"]; ?>">Accept</a>
          </td>
        </tr>
        <?php $j++; ?>
      <?php endforeach; ?>
