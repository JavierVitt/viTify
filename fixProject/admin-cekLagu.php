...
if (isset($_POST["search"])) {
  ...
  if ($string === '') {
    ...
    $syn = "SELECT * FROM LAGU WHERE id_lagu = '$string' OR judul_lagu LIKE '%$string%' OR penyanyi LIKE '%$string%' OR genre LIKE '%$string%' OR tanggal_rilis LIKE '%$string%' OR link LIKE '%$string%'";
    $hasils = query($syn);
  }
}
?>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <a class="nav-link mx-2 active" aria-current="page" href="#">Cek Lagu</a>
              </li>
              <li class="nav-item">
    ...
    <table class="table table-bordered">
      ...
      <?php foreach ($hasils as $hasil) : ?>
        <tr>
          ...
          <td>
            <?php echo $hasil["id_lagu"]; ?>
          </td>
          <td>
            <?php echo $hasil["judul_lagu"]; ?>
          </td>
          <td>
            <?php echo $hasil["penyanyi"]; ?>
          </td>
          <td>
            <?php echo $hasil["genre"]; ?>
          </td>
          <td>
            <?php echo $hasil["tanggal_rilis"] ?>
          </td>
          <td>
            <?php echo $hasil["link"]; ?>
          </td>
          <td>
            <a class="btn btn-danger" href="deleteLagu.php?id=<?php echo $hasil["id_lagu"]; ?>">Delete !!</a>
          </td>
        </tr>
        <?php $j++; ?>
      <?php endforeach; ?>
